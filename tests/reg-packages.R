...
stopifnot(exprs = {
    res[["foo-class"]]$missing_description  # was part of checkRd() in R < 4.4.0
    identical(res[["identity"]]$arguments_with_no_description, "x")
    ## R < 4.4.0 treated \n and Rd comments as sufficient content
    ## FIXME: should also warn about auto-generated promptPackage() content
})
