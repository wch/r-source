...
bibentry(bibtype = "Article",
         ...
         title = "A Remark on {Algorithm 643}: {FEXACT}: An Algorithm for Performing {Fisher}’s Exact Test in \\eqn{r \\times c}{r x c} Contingency Tables",
         volume = "19",
         .issn = "1557-7295",
...
bibentry(bibtype = "Article",
         ...
         title = "{Algorithm AS 136}: A \\eqn{K}{K}-Means Clustering Algorithm",
         volume = "28",
         .issn = "0035-9254",
         doi = "10.2307/2346830",
         number = "1",
...
bibentry(bibtype = "Article",
         key = "R:Hill:1970",
         title = "{ACM} {Algorithm 395}: Student’s \\eqn{t}{t}-Distribution",
         volume = "13",
         .issn = "1557-7317",
...
bibentry(bibtype = "Article",
         key = "R:Hill:1981",
         title = "Remark on “{Algorithm 396}: Student’s \\eqn{t}{t}-Quantiles [S14]”",
         volume = "7",
         .issn = "1557-7295",
...
bibentry(bibtype = "Article",
         key = "R:Lenth:1989",
         title = "{Algorithm AS 243}: Cumulative Distribution Function of the Non-Central \\eqn{t}{t} Distribution",
         volume = "38",
         .issn = "0035-9254",
         doi = "10.2307/2347693",
         number = "1",
...
bibentry(bibtype = "Article",
         ...
         title = "A Network Algorithm for Performing {Fisher}’s Exact Test in \\eqn{r \\times c}{r x c} Contingency Tables",
         volume = "78",
         .issn = "1537-274X",
...
bibentry(bibtype = "Article",
         ...
         title = "{Algorithm 643}: {FEXACT}: A {FORTRAN} Subroutine for {Fisher}’s Exact Test on Unordered \\eqn{r \\times c}{r x c} Contingency Tables",
         volume = "12",
         .issn = "1557-7295",
...
bibentry(bibtype = "Article",
         ...
         title = "{Algorithm AS 159}: An Efficient Method of Generating Random \\eqn{R \\times C}{R × C} Tables with Given Row and Column Totals",
         volume = "30",
         .issn = "0035-9254",
         doi = "10.2307/2346669",
         number = "1",
...
bibentry(bibtype = "Article",
         key = "R:Royston:1982a",
         title = "An Extension of {Shapiro} and {Wilk}’s \\eqn{W}{W} Test for Normality to Large Samples",
         volume = "31",
         .issn = "0035-9254",
         doi = "10.2307/2347973",
         number = "2",
...
bibentry(bibtype = "Article",
         key = "R:Royston:1982b",
         title = "{Algorithm AS 181}: The \\eqn{W}{W} Test for Normality",
         volume = "31",
         .issn = "0035-9254",
         doi = "10.2307/2347986",
         number = "2",
...
bibentry(bibtype = "Article",
         key = "R:Royston:1995",
         title = "{Remark AS R94}: A Remark on {Algorithm AS 181}: The \\eqn{W}{W}-test for Normality",
         volume = "44",
         .issn = "0035-9254",
         doi = "10.2307/2986146",
         number = "4",
...
bibentry(bibtype = "Article",
         key = "R:Sarkar:1998",
         title = "Some Probability Inequalities for Ordered \\eqn{\\mathrm{MTP}_2}{MTP_2} Random Variables: A Proof of the {Simes} Conjecture",
         volume = "26",
         .issn = "0090-5364",
