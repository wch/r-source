...
bibentry(bibtype = "Article",
         key = "R:Belisle:1992",
         title = "Convergence Theorems for a Class of Simulated Annealing Algorithms on \\eqn{\\mathbb{R}^d}{R^d}",
         volume = "29",
         .issn = "1475-6072",
         doi = "10.2307/3214721",
         number = "4",
...
bibentry(bibtype = "Article",
         key = "R:Sarkar:1998",
         title = "Some Probability Inequalities for Ordered \\eqn{\\mathrm{MTP}_2}{MTP2} Random Variables: A Proof of the {Simes} Conjecture",
         volume = "26",
         .issn = "0090-5364",
...
bibentry(bibtype = "Article",
         ...
         author = c(person(c("Roy", "T."), "St. Laurent"),
                    person(c("R.", "Dennis"), "Cook")),
...
bibentry(bibtype = "Article",
         key = "R:Fay+Malinovsky:2018",
         author = c(person(given = c("Michael", "P."),
                           family = "Fay"),
                    person(given = "Yaakov",
                           family = "Malinovsky")),
...
bibentry(bibtype = "Article",
         key = "R:Sewak+Hothorn:2023",
         author = c(person(given = "Ainesh",
                           family = "Sewak"),
...
bibentry(bibtype = "Book",
         key = "R:Van_der_Vaart:1998",
         title = "Asymptotic Statistics",
         author = person(given = c("Aart", "W."),
                         family = "Van der Vaart"),
         year = "1998",
         publisher = "Cambridge University Press",
...
bibentry(bibtype = "Article",
         key = "R:Wilk+Gnanadesikan:1968",
         author = c(person(given = c("M.", "B."),
                           family = "Wilk"),
                    person(given = "R.",
                           family = "Gnanadesikan")),
...
bibentry(bibtype = "Article",
         ...
         number = "5",
         pages = "87--89",
         url = "https://de.wikipedia.org/wiki/Datei:MannWhitney_151102.pdf")

bibentry(bibtype = "Article",
         key = "R:Mann+Whitney:1947",
         author = c(person(given = c("Henry", "B."),
                           family = "Mann"),
                    person(given = c("Donald", "R."),
                           family = "Whitney")),
