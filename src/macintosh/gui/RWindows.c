/*
	...
	************************************************************************************************ 
    ...
    as the way R want.In here, we will handle most of the things related to Window, the other 
    routine which is related to Graphic Window may be appear in another file called "RGWindow". 
    
    The R Programme will create four different kinds of window in this moment, they are Console, 
    Edit, Help and Graphic Window.
    Console Window : It is a Edit Window with a lot of functionality. You can only have one console
              window, when the Console window closed, the application closed. You can't remain the 
              application open without the console window. This is very important, cause there have
              a huge part of program is based on this assumption.
    ...
    Help Window    : Exactly like Edit Window. except I disable some of the functions.
    	
	************************************************************************************************ 
    Notes:
    In here, we need to pay attention how WASTE create a window. If you using another methods to
    create another kind of window, you better create another event handlers for those window. All
    the thing like windowPtr, DocumentHandle and WE instance is highly related. If you using some 
    standard methods to create another kind of winodw. They will probably generate linking error when
    they handling the events implement in here.
...
/* ************************************************************************************************
Resize : when you resize a graphic window, you need to redraw the content. 
************************************************************************************************ */
...
DoGrow:
*************************************************************************************************** 
When the console window grow, you need to reset the option width. Unfortunately, the function 
CharWidth didn't doing the thing we expected. We need to multiple a constant 0.75 (by experiment)
...
/* ************************************************************************************************
ScrollProc: this is a callback tourine called by the Toolbox Control Manager move the scroll bar 
thumb and scroll the text accordingly
************************************************************************************************ */
...
/* ************************************************************************************************
DoContent: This function will be called when you click inside the window
************************************************************************************************ */
...
/* ************************************************************************************************
DoKey : handle key event (keyPgUp, keyPgDn, keyHome ...)
************************************************************************************************ */
...
DoUpdate:
*************************************************************************************************** 
Based on WASTE DEMO. However, when you update a graphic window, you need to do something more than
Text window.
************************************************************************************************ */
...
DoActivate : 
*************************************************************************************************** 
Based on WASTE DEMO. However, when you activate a graphic window, you need to do something more
than Text window.
************************************************************************************************ */
...
CreateGraphicWindow
*************************************************************************************************** 
This routine is used to create a Graphic window. You need to resize the window as the parameter
specified.
************************************************************************************************ */
...
/* ************************************************************************************************
CreateWindow: Create Text Window
************************************************************************************************ */
...
/* ************************************************************************************************
newWindow : General Procedure , which used to create a new window (all kind of windows)
************************************************************************************************ */
...
hideTextRect: 
*************************************************************************************************** 
Used in Graphic window, which hide the corresponding TextEdit Field. We hide the TextField instead
of creating another kind of window, because the event processing procedure is based on the WASTE 
DEMO. Thus, if we have two different kind of window structure. You need to rewrite the event 
handling procedure too.
************************************************************************************************ */
