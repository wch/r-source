...
SEXP ALTREP_UNSERIALIZE(SEXP, SEXP, SEXP);
R_xlen_t ALTVEC_LENGTH(SEXP x);
R_xlen_t ALTVEC_TRUELENGTH(SEXP x);
void *ALTVEC_DATAPTR(SEXP x);
void *ALTVEC_DATAPTR_OR_NULL(SEXP x);
...
SEXP R_deferred_coerceToString(SEXP v);
