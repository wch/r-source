/* zsifa.f -- translated by f2c (version 19971204).
...
/*     zsifa factors a double complex symmetric matrix by elimination */
...
/* Subroutine */ int zsifa(doublecomplex *a, integer *lda, integer *n, 
