/* zhisl.f -- translated by f2c (version 19971204).
...
/*     zhisl solves the double complex hermitian system */
/*     a * x = b */
...
/* Subroutine */ int zhisl(doublecomplex *a, integer *lda, integer *n, 
...
/*              apply the transformation. */
    ...
    i__2 = k;
    i__3 = k - 1;
    zdotc(&z__2, &i__3, &a[k * a_dim1 + 1], &c__1, &b[1], &c__1);
...
/*              apply the transformation. */
    ...
    i__2 = k + 1;
    i__3 = k - 1;
    zdotc(&z__2, &i__3, &a[(k + 1) * a_dim1 + 1], &c__1, &b[1], &c__1);
    z__1.r = b[i__2].r + z__2.r, z__1.i = b[i__2].i + z__2.i;
    b[i__1].r = z__1.r, b[i__1].i = z__1.i;
    kp = (i__1 = kpvt[k], abs(i__1));
    if (kp == k) {
