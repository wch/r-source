...
int CALLBACK PrintMetafile(HDC hdc, HANDLETABLE* lpHTable,
...
BOOL RPrintBitMap(LPBITMAPINFO lpbi, LPBYTE lpbm)
{
    ...
    rcaps=StretchDIBits(pd.hDC, 20,20,lpbi->bmiHeader.biWidth*xmult,
			lpbi->bmiHeader.biHeight*xmult,0,0,
			lpbi->bmiHeader.biWidth,
			lpbi->bmiHeader.biHeight,
			lpbm, lpbi, DIB_RGB_COLORS, SRCCOPY );
