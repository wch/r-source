...
SEXP optim(SEXP call, SEXP op, SEXP args, SEXP rho)
{
    ...
    SET_STRING_ELT_FROM_CSTR(names, 0, "par");
    SET_STRING_ELT_FROM_CSTR(names, 1, "value");
    SET_STRING_ELT_FROM_CSTR(names, 2, "counts");
    SET_STRING_ELT_FROM_CSTR(names, 3, "convergence");
    SET_STRING_ELT_FROM_CSTR(names, 4, "message");
    ...
    SET_STRING_ELT_FROM_CSTR(countnames, 0, "function");
    SET_STRING_ELT_FROM_CSTR(countnames, 1, "gradient");
