/* sinerp.f -- translated by f2c (version 19971204).
...
/* Subroutine */ int sinerp(doublereal *abd, integer *ld4, integer *nk, 
	doublereal *p1ip, doublereal *p2ip, integer *ldnk, integer *flag__)
{
