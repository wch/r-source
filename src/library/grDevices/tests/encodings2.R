...
valid_printable <- list(
    c(32:126,160:255), # latin1
    c(32:126,160:255), # latin2
    c(32:126,160:255), # iso-8859-13
    c(32:126,160:255), # latin-9
    c(32:126,160,163,166:169,171:173,175:209,211:254), # iso-8859-7
      # 161, 162 - Windows uses normal quotes, but Linux/macOS uses fancy
      # 164, 165, 170 - 2003 additions not supported by Windows
    c(32:126,160:255), # iso-8859-5
    c(32:126,160:255), # KOI8-R
    c(32:126,128:173,175:189,191:255), # KOI8-U
      # 174, 190 - Windows uses characters from KOI8-RU (U+45e, U+40e),
      #            which differs from Unix (R+255d, U+256c)
    c(32:126,128,130:140,142,145:156,158:255), # CP1252
    c(32:126,128,130,132:135,137:143,145:151,153:255), # CP1250
    c(32:126,128:151,153:255), # CP1251
    c(32:126,128,130:135,137,139,145:151,153,155,160:169,171:209,211:254), # CP1253
    c(32:126,128,130,132:135,137,139,141:143,145:151,153,155,157:158,160,162:164,166:255) # CP1257
)
...
for (i in seq_along(pdfenc)) {
    message("testing ", pdfenc[i], " with cairo_pdf")
    do_one(i)
}
dev.off()
