...
void initGPar(pGEDevDesc dd)
{
    ...
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_FILL, "fill");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_COL, "col");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_GAMMA, "gamma");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LTY, "lty");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LWD, "lwd");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_CEX, "cex");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_FONTSIZE, "fontsize");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LINEHEIGHT, "lineheight");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_FONT, "font");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_FONTFAMILY, "fontfamily");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_ALPHA, "alpha");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LINEEND, "lineend");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LINEJOIN, "linejoin");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LINEMITRE, "linemitre");
    SET_STRING_ELT_FROM_CSTR(gparnames, GP_LEX, "lex");
    setAttrib(gpar, R_NamesSymbol, gparnames);
    PROTECT(gpfill = allocVector(STRSXP, 1));
    SET_STRING_ELT_FROM_CSTR(gpfill, 0, col2name(dev->startfill));
    SET_VECTOR_ELT(gpar, GP_FILL, gpfill);
    PROTECT(gpcol = allocVector(STRSXP, 1));
    SET_STRING_ELT_FROM_CSTR(gpcol, 0, col2name(dev->startcol));
     ...
     */
    SET_STRING_ELT_FROM_CSTR(gpfontfamily, 0, "");
    ...
    SET_STRING_ELT_FROM_CSTR(gplineend, 0, "round");
    SET_VECTOR_ELT(gpar, GP_LINEEND, gplineend);
    PROTECT(gplinejoin = allocVector(STRSXP, 1));
    SET_STRING_ELT_FROM_CSTR(gplinejoin, 0, "round");
    ...
    SET_STRING_ELT_FROM_CSTR(class, 0, "gpar");
