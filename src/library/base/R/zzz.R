...
## Do not edit by hand!
## Use tools:::.deparse_S3_methods_table_for_base() to re-create.
## Modify tools:::.make_S3_methods_table_for_base() as necessary.
.S3_methods_table <-
cbind(generic =
      c("!", "!", "$", "$", "$", "$<-", "&", "&", "*", "+", "+", "-", 
        "-", "/", "[", "[", "[", "[", "[", "[", "[", "[", "[", "[", "[", 
        "[", "[", "[", "[", "[", "[", "[<-", "[<-", "[<-", "[<-", "[<-", 
        "[<-", "[[", "[[", "[[", "[[", "[[", "[[<-", "[[<-", "[[<-", 
        "|", "|", "Math", "Math", "Math", "Math", "Math", "Ops", "Ops", 
        "Ops", "Ops", "Ops", "Ops", "Ops", "Summary", "Summary", "Summary", 
        "Summary", "Summary", "Summary", "Summary", "Summary", "all.equal", 
        "all.equal", "all.equal", "all.equal", "all.equal", "all.equal", 
        "all.equal", "all.equal", "all.equal", "all.equal", "all.equal", 
        "anyDuplicated", "anyDuplicated", "anyDuplicated", "anyDuplicated", 
        "anyNA", "anyNA", "aperm", "aperm", "as.Date", "as.Date", "as.Date", 
        "as.Date", "as.Date", "as.Date", "as.Date", "as.Date", "as.POSIXct", 
        "as.POSIXct", "as.POSIXct", "as.POSIXct", "as.POSIXct", "as.POSIXct", 
        "as.POSIXlt", "as.POSIXlt", "as.POSIXlt", "as.POSIXlt", "as.POSIXlt", 
        "as.POSIXlt", "as.POSIXlt", "as.POSIXlt", "as.array", "as.character", 
        "as.character", "as.character", "as.character", "as.character", 
        "as.character", "as.character", "as.character", "as.character", 
        "as.character", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.data.frame", "as.data.frame", "as.data.frame", 
        "as.data.frame", "as.double", "as.double", "as.expression", "as.function", 
        "as.list", "as.list", "as.list", "as.list", "as.list", "as.list", 
        "as.list", "as.list", "as.logical", "as.matrix", "as.matrix", 
        "as.matrix", "as.matrix", "as.null", "as.single", "as.table", 
        "as.vector", "by", "by", "c", "c", "c", "c", "c", "c", "c", "cbind", 
        "chol", "close", "close", "close", "conditionCall", "conditionMessage", 
        "cut", "cut", "cut", "determinant", "diff", "diff", "diff", "diff", 
        "dim", "dimnames", "dimnames<-", "droplevels", "droplevels", 
        "duplicated", "duplicated", "duplicated", "duplicated", "duplicated", 
        "duplicated", "duplicated", "flush", "format", "format", "format", 
        "format", "format", "format", "format", "format", "format", "format", 
        "format", "format", "format", "format", "getDLLRegisteredRoutines", 
        ...
        "labels", "length", "length<-", "levels", "levels<-", "mean", 
        "mean", "mean", "mean", "mean", "merge", "merge", "months", "months", 
        "names", "names<-", "open", "open", "open", "open", "pretty", 
        "print", "print", "print", "print", "print", "print", "print", 
        "print", "print", "print", "print", "print", "print", "print", 
        "print", "print", "print", "print", "print", "print", "print", 
        "print", "print", "print", "print", "print", "print", "print", 
        "print", "print", "print", "print", "print", "print", "print", 
        "print", "qr", "quarters", "quarters", "range", "rbind", "rep", 
        "rep", "rep", "rep", "rep", "rev", "round", "round", "row.names", 
        "row.names", "row.names<-", "row.names<-", "rowsum", "rowsum", 
        "scale", "seek", "seq", "seq", "seq", "solve", "solve", "sort", 
        "sort", "split", "split", "split", "split", "split<-", "split<-", 
        "subset", "subset", "subset", "summary", "summary", "summary", 
        "summary", "summary", "summary", "summary", "summary", "summary", 
        "summary", "summary", "summary", "summary", "t", "t", "toString", 
        "transform", "transform", "trunc", "trunc", "truncate", "unique", 
        "unique", "unique", "unique", "unique", "unique", "unique", "units", 
        "units<-", "weekdays", "weekdays", "with", "within", "within", 
        "xtfrm", "xtfrm", "xtfrm", "xtfrm", "xtfrm", "xtfrm", "xtfrm", 
        "xtfrm", "xtfrm"),
      class =
      c("hexmode", "octmode", "DLLInfo", "data.frame", "package_version", 
        "data.frame", "hexmode", "octmode", "difftime", "Date", "POSIXt", 
        "Date", "POSIXt", "difftime", "AsIs", "DLLInfoList", "Date", 
        "Dlist", "POSIXct", "POSIXlt", "data.frame", "difftime", "factor", 
        "hexmode", "listof", "noquote", "numeric_version", "octmode", 
        "simple.list", "table", "warnings", "Date", "POSIXct", "POSIXlt", 
        "data.frame", "factor", "numeric_version", "Date", "POSIXct", 
        "data.frame", "factor", "numeric_version", "data.frame", "factor", 
        "numeric_version", "hexmode", "octmode", "Date", "POSIXt", "data.frame", 
        "difftime", "factor", "Date", "POSIXt", "data.frame", "difftime", 
        "factor", "numeric_version", "ordered", "Date", "POSIXct", "POSIXlt", 
        "data.frame", "difftime", "factor", "numeric_version", "ordered", 
        "POSIXt", "character", "default", "envRefClass", "environment", 
        "factor", "formula", "language", "list", "numeric", "raw", "array", 
        "data.frame", "default", "matrix", "POSIXlt", "numeric_version", 
        "default", "table", "POSIXct", "POSIXlt", "character", "date", 
        "dates", "default", "factor", "numeric", "Date", "POSIXlt", "date", 
        "dates", "default", "numeric", "Date", "POSIXct", "character", 
        "date", "dates", "default", "factor", "numeric", "default", "Date", 
        ...
        "default", "Date", "POSIXct", "data.frame", "default", "environment", 
        "factor", "function", "numeric_version", "factor", "POSIXlt", 
        "data.frame", "default", "noquote", "default", "default", "default", 
        "factor", "data.frame", "default", "Date", "POSIXct", "POSIXlt", 
        "difftime", "noquote", "numeric_version", "warnings", "data.frame", 
        "default", "connection", "srcfile", "srcfilealias", "condition", 
        "condition", "Date", "POSIXt", "default", "matrix", "Date", "POSIXt", 
        "default", "difftime", "data.frame", "data.frame", "data.frame", 
        "data.frame", "factor", "POSIXlt", "array", "data.frame", "default", 
        "matrix", "numeric_version", "warnings", "connection", "AsIs", 
        "Date", "POSIXct", "POSIXlt", "data.frame", "default", "difftime", 
        "factor", "hexmode", "libraryIQR", "numeric_version", "octmode", 
        "packageInfo", "summaryDefault", "DLLInfo", "character", "POSIXlt", 
        "data.frame", "numeric_version", "default", "factor", "numeric_version", 
        "Date", "POSIXt", "difftime", "matrix", "Date", "POSIXt", "default", 
        "lm", "qr", "default", "POSIXlt", "factor", "default", "factor", 
        ...
        "data.frame", "list", "AsIs", "Date", "POSIXct", "POSIXlt", "Surv", 
        "default", "difftime", "factor", "numeric_version"))
