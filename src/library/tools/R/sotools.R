...
## and in a non-API heder or no header at all.
            ...
            "R_AccuracyInfo", "R_AllocStringBuffer", "R_CStackLimit",
            "R_CStackStart", "R_CleanTempDir", "R_ClearerrConsole",
            "R_CollectFromIndex", "R_CompiledFileName",
            "R_Consolefile", "R_CurrentExpr", "R_Decode2Long",
            "R_DefParams", "R_DirtyImage", "R_EvalDepth",
            "R_FileExists", "R_FinalizeSrcRefState",
            "R_FreeStringBuffer", "R_FunTab", "R_GE_setVFontRoutines",
            "R_GUIType", "R_GetTraceback", "R_GetVarLocMISSING",
            "R_GetVarLocSymbol", "R_GetVarLocValue",
            "R_GlobalContext", "R_HistoryFile", "R_HistorySize",
            "R_Home", "R_HomeDir", "R_InitSrcRefState",
            "R_InputHandlers", "R_Interactive", "R_Is_Running",
            "R_JumpToToplevel", "R_LookupMethod",
            "R_MakeExternalPtrFn", "R_MethodsNamespace",
            "R_NewHashedEnv", "R_OpenCompiledFile", "R_Outputfile",
            "R_PV", "R_ParseBuffer", "R_ParseConn", "R_ParseContext",
            "R_ParseContextLast", "R_ParseContextLine",
            "R_ParseError", "R_ParseErrorMsg", "R_ParseFile",
            "R_Parse1Buffer", "R_Parse1File", "R_PolledEvents",
            "R_PrintDeferredWarnings", "R_PromptString",
            "R_ReplDLLdo1", "R_ReplDLLinit", "R_RestoreGlobalEnv",
            "R_RestoreGlobalEnvFromFile", "R_RestoreHistory",
            "R_ReturnOrRestart", "R_SaveGlobalEnv",
            "R_SaveGlobalEnvToFile", "R_SelectEx", "R_SessionContext",
            "R_SetErrmessage", "R_SetErrorHook", "R_SetPPSize",
            "R_SetParams", "R_SetVarLocValue", "R_SetWarningHook",
            "R_SignalHandlers", "R_SizeFromEnv", "R_Slave",
            "R_SrcfileSymbol", "R_SrcrefSymbol", "R_TempDir",
            "R_Toplevel", "R_ToplevelContext", "R_Visible",
            "R_WriteConnection", "R_Zero_Hack", "R_addTaskCallback",
            "R_cairoCdynload", "R_checkActivity", "R_checkActivityEx",
            ...
            "R_isMethodsDispatchOn", "R_moduleCdynload",
            "R_order2dbl_int", "R_order2double", "R_order2int",
            "R_order2int_dbl", "R_pretty0", "R_primitive_generic",
            "R_primitive_methods", "R_print", "R_removeTaskCallback",
            "R_runHandlers", "R_running_as_main_program",
            ...
            "R_setupHistory", "R_strtod4", "R_subassign3_dflt",
            "R_taskCallbackRoutine", "R_timeout_handler",
            "R_timeout_val", "R_wait_usec", "Rconn_fgetc",
            "Rconn_getline", "Rconn_printf", "Rconn_ungetc",
            "Rcons_vprintf", "Rdownload", "RestoreAction",
            "Rf_CleanEd", "Rf_EncodeComplex", "Rf_EncodeElement",
            "Rf_EncodeEnvironment", "Rf_EncodeInteger",
            "Rf_EncodeLogical", "Rf_EncodeRaw", "Rf_EncodeReal",
            "Rf_EncodeString", "Rf_ErrorMessage", "Rf_GLPretty",
            "Rf_GPretty", "Rf_GetOptionCutoff",
            "Rf_GetOptionDeviceAsk", "Rf_InitNames",
            "Rf_KillAllDevices", "Rf_NewEnvironment",
            "Rf_PrintDefaults", "Rf_PrintWarnings",
            "Rf_ReplIteration", "Rf_Scollate", "Rf_Seql",
            ...
            "Rf_isProtected", "Rf_isValidName", "Rf_jump_to_toplevel",
            "Rf_mainloop", "Rf_mbrtowc", "Rf_mkFalse", "Rf_mkTrue",
            ...
            "dcar", "dcdr", "dchdc_", "do_Rprof", "do_Rprofmem",
            ...
            "printRawVector", "process_site_Renviron",
            "process_system_Renviron", "process_user_Renviron",
            "ptr_R_Busy", "ptr_R_ChooseFile", "ptr_R_CleanUp",
            "ptr_R_ClearerrConsole", "ptr_R_EditFile",
            "ptr_R_EditFiles", "ptr_R_FlushConsole",
            "ptr_R_ProcessEvents", "ptr_R_ReadConsole",
            "ptr_R_ResetConsole", "ptr_R_ShowFiles",
            "ptr_R_ShowMessage", "ptr_R_Suicide",
            "ptr_R_WriteConsole", "ptr_R_WriteConsoleEx",
            "ptr_R_addhistory", "ptr_R_loadhistory",
            "ptr_R_savehistory", "ptr_do_dataentry",
            "ptr_do_dataviewer", "ptr_do_selectlist", "pythag_",
            "removeInputHandler", "rs_", "run_Rmainloop", "rwarnc_",
            "savePalette", "setup_Rmainloop", "signrank_free",
            "tql2_", "tqlrat_", "tred1_", "tred2_", "utf8Valid",
