...
## and in a non-API heder or no header at all.
            ...
            "R_CurrentExpr", "R_Decode2Long", "R_DefParams",
            "R_FileExists", "R_FinalizeSrcRefState",
            "R_FreeStringBuffer", "R_FunTab", "R_GE_setVFontRoutines",
            "R_GetTraceback", "R_GetVarLocMISSING",
            "R_GetVarLocSymbol", "R_GetVarLocValue",
            "R_InitSrcRefState", "R_Is_Running", "R_JumpToToplevel",
            "R_LookupMethod", "R_MakeExternalPtrFn",
            "R_MethodsNamespace", "R_NewHashedEnv",
            "R_OpenCompiledFile", "R_PV", "R_ParseBuffer",
            "R_ParseConn", "R_ParseContext", "R_ParseContextLast",
            "R_ParseContextLine", "R_ParseError", "R_ParseErrorMsg",
            "R_ParseFile", "R_Parse1Buffer", "R_Parse1File",
            "R_PrintDeferredWarnings", "R_PromptString",
            "R_ReplDLLdo1", "R_ReplDLLinit", "R_ReturnOrRestart",
            "R_SessionContext", "R_SetErrmessage", "R_SetErrorHook",
            "R_SetPPSize", "R_SetParams", "R_SetVarLocValue",
            "R_SetWarningHook", "R_SizeFromEnv", "R_SrcfileSymbol",
            "R_SrcrefSymbol", "R_TempDir", "R_Toplevel",
            "R_ToplevelContext", "R_Visible", "R_WriteConnection",
            "R_Zero_Hack", "R_addTaskCallback", "R_cairoCdynload",
            "R_common_command_line", "R_data_class",
            ...
            "R_removeTaskCallback", "R_running_as_main_program",
            "R_setInternetRoutines", "R_setLapackRoutines",
            "R_setStartTime", "R_setX11Routines",
            "R_set_command_line_arguments", "R_set_prim_method",
            "R_set_quick_method_check", "R_set_standardGeneric_ptr",
            "R_strtod4", "R_subassign3_dflt", "R_taskCallbackRoutine",
            "R_timeout_handler", "R_timeout_val", "Rconn_fgetc",
            "Rconn_printf", "Rconn_ungetc", "Rdownload",
            "RestoreAction", "Rf_CleanEd", "Rf_EncodeComplex",
            ...
            "Rf_KillAllDevices", "Rf_NewEnvironment",
            "Rf_PrintDefaults", "Rf_PrintWarnings",
            "Rf_ReplIteration", "Rf_Seql", "Rf_StrToInternal",
            "Rf_VectorIndex", "Rf_WarningMessage",
            ...
            "Rf_endEmbeddedR", "Rf_endcontext", "Rf_envlength",
            "Rf_formatComplex", "Rf_formatInteger",
            "Rf_formatLogical", "Rf_formatRaw", "Rf_formatReal",
            "Rf_formatString", "Rf_initEmbeddedR", "Rf_initStack",
            "Rf_init_con", "Rf_initialize_R", "Rf_internalTypeCheck",
            "Rf_isProtected", "Rf_isValidName", "Rf_mbrtowc",
            "Rf_mkFalse", "Rf_mkTrue", "Rf_printArray",
            ...
            "cpuLimit", "cpuLimit2", "cpuLimitValue", "csduplicated",
            "currentTime", "dcar", "dcdr", "do_Rprof", "do_Rprofmem",
            ...
            "get_workspace_name", "inherits3", "known_to_be_latin1",
            ...
            "printRawVector", "pythag_", "rs_", "run_Rmainloop",
            "rwarnc_", "savePalette", "setup_Rmainloop",
            "signrank_free", "tql2_", "tqlrat_", "tred1_", "tred2_",
            "utf8Valid", "utf8locale", "wilcox_free", "yylloc")
...
frontends <-
    c("R_CStackLimit", "R_CStackStart", "R_ClearerrConsole",
      "R_Consolefile", "R_DirtyImage", "R_GUIType", "R_GlobalContext",
      "R_HistoryFile", "R_HistorySize", "R_Home", "R_HomeDir",
      "R_InputHandlers", "R_Interactive", "R_Outputfile",
      "R_PolledEvents", "R_RestoreGlobalEnv",
      "R_RestoreGlobalEnvFromFile", "R_RestoreHistory",
      "R_SaveGlobalEnv", "R_SaveGlobalEnvToFile", "R_SelectEx",
      "R_SignalHandlers", "R_Slave", "R_Suicide", "R_checkActivity",
      "R_checkActivityEx", "R_runHandlers", "R_setStartTime",
      "R_setupHistory", "R_wait_usec", "Rf_jump_to_toplevel",
      "Rf_mainloop", "addInputHandler", "fpu_setup", "getInputHandler",
      "getSelectedHandler", "initStdinHandler", "process_site_Renviron",
      "process_system_Renviron", "process_user_Renviron", "ptr_R_Busy",
      "ptr_R_ChooseFile", "ptr_R_CleanUp", "ptr_R_ClearerrConsole",
      "ptr_R_EditFile", "ptr_R_EditFiles", "ptr_R_FlushConsole",
      "ptr_R_ProcessEvents", "ptr_R_ReadConsole", "ptr_R_ResetConsole",
      "ptr_R_ShowFiles", "ptr_R_ShowMessage", "ptr_R_Suicide",
      "ptr_R_WriteConsole", "ptr_R_WriteConsoleEx", "ptr_R_addhistory",
      "ptr_R_loadhistory", "ptr_R_savehistory", "ptr_do_dataentry",
      "ptr_do_dataviewer", "ptr_do_selectlist", "removeInputHandler")
