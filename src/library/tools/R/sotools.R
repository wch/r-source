...
## and in a non-API heder or no header at all.
            ...
            "R_timeout_val", "R_wait_usec",
            "Rconn_fgetc", "Rconn_getline", "Rconn_printf",
            "Rconn_ungetc", "Rcons_vprintf", "Rdownload",
            ...
            "dqrcf_", "dqrdc2_", "dqrls_", "dqrqty_", "dqrqy_",
