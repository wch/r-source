...
## and in a non-API heder or no header at all.
            ...
            "R_GetVarLocValue", "R_InitSrcRefState", "R_Is_Running",
            ...
            "R_PromptString", "R_SessionContext", "R_SetPPSize",
            "R_SetVarLocValue", "R_SrcfileSymbol", "R_SrcrefSymbol",
            ...
            "Rconn_fgetc", "Rconn_printf", "Rconn_ungetc",
...
frontends <-
    c("AllDevicesKilled", "R_CStackLimit", "R_CStackStart",
      ...
      "R_wait_usec", "Rf_CleanEd" , "Rf_KillAllDevices",
      "Rf_endEmbeddedR", "Rf_initEmbeddedR", "Rf_initialize_R",
