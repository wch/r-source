...
## and in a non-API heder or no header at all.
            ...
            "R_ReturnOrRestart", "R_SessionContext",
            "R_SetErrmessage", "R_SetErrorHook", "R_SetPPSize",
            "R_SetVarLocValue", "R_SetWarningHook", "R_SrcfileSymbol",
            "R_SrcrefSymbol", "R_Toplevel", "R_ToplevelContext",
            "R_Visible", "R_WriteConnection", "R_Zero_Hack",
            ...
            "R_setX11Routines", "R_set_prim_method",
...
frontends <-
    c("AllDevicesKilled", "CleanEd", "R_CStackLimit", "R_CStackStart",
      ...
      "R_setupHistory", "R_wait_usec", "Rf_endEmbeddedR",
      "Rf_initEmbeddedR", "Rf_initialize_R", "Rf_jump_to_toplevel",
      "Rf_KillAllDevices", "Rf_mainloop", "addInputHandler",
      "editorcleanall", "fpu_setup", "getDLLVersion",
      "getInputHandler", "getRUser", "get_R_HOME",
