...
enum { TGZ_EXTRACT, TGZ_LIST, TGZ_VLIST, TGZ_INVALID };
...
int main(int argc, char **argv)
{
	...
	if (argc == ++arg) help(0);
	       ...
	       strcmp(argv[arg], "ztf") == 0) {
	action = TGZ_LIST;
	if (argc == ++arg) help(0);
    } else if (strcmp(argv[arg], "-h") == 0) help(0);
    else if (strcmp(argv[arg], "xf") == 0 || 
	     strcmp(argv[arg], "zxf") == 0) {
	action = TGZ_EXTRACT;
	if (argc == ++arg) help(0);
    }
    ...
    ++arg;
    if ((action == TGZ_LIST || action == TGZ_VLIST ) && (arg != argc)) help(1);
