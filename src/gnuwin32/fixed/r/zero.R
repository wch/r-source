...
##    not necessary (and indeed an error) to assign the function in
##    frame 1.  The function f.check can see the function f because it
##    exists in the environment where f is defined.
##
## 2. It is also not necessary (although permissible) to wrap a "list"
##    around the function f.check in the .C call.  R passes such
##    functions through to the underlying C code in "undigested" form.
