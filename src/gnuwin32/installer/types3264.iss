...
[Components]
Name: "main"; Description: "Core Files"; Types: user user32 user64 compact full custom
Name: "i386"; Description: "i386 Files"; Types: user user32 compact full custom;
Name: "x64"; Description: "x64 Files"; Types: user user64 add64 full custom
...
Name: "manuals/technical"; Description: "Technical Manuals"; Types: user user32 user64 full custom
Name: "manuals/refman"; Description: "PDF help pages (reference manual)"; Types: user user32 user64 full custom
Name: "manuals/libdocs"; Description: "Docs for Packages grid, Matrix and survival"; Types: user user32 user64 full custom
...
Name: "tcl/tzdata"; Description: "Timezone files for Tcl"; Types: user user32 user64 full custom
Name: "tcl/chm"; Description: "Tcl/Tk Help (Compiled HTML)"; Types: user user32 user64 full custom
Name: "tcl/msg"; Description: "Message translations for Tcl/Tk"; Types: user user32 user64 full custom
Name: "trans"; Description: "Message Translations"; Types: user user32 user64 full custom
Name: "tests"; Description: "Test files"; Types: user user32 user64 full custom
