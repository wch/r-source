...
Name: "{commondesktop}\R @RVER@"; Filename: "{app}\bin\i386\Rgui.exe"; MinVersion: 0,5.0; Tasks: desktopicon; WorkingDir: "{app}"; Parameters: "--cd-to-userdocs"; Check: RIsAdmin
...
Root: HKLM; Subkey: "Software\@Producer@\R32"; Flags: uninsdeletekeyifempty; Tasks: recordversion; Check: RIsAdmin
Root: HKLM; Subkey: "Software\@Producer@\R32"; Flags: uninsdeletevalue; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Tasks: recordversion; Check: RIsAdmin
Root: HKLM; Subkey: "Software\@Producer@\R32"; Flags: uninsdeletevalue; ValueType: string; ValueName: "Current Version"; ValueData: "@RVER@"; Tasks: recordversion; Check: RIsAdmin
Root: HKLM; Subkey: "Software\@Producer@\R32\@RVER@"; Flags: uninsdeletekey; Tasks: recordversion; Check: RIsAdmin
Root: HKLM; Subkey: "Software\@Producer@\R32\@RVER@"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Tasks: recordversion; Check: RIsAdmin
...
Root: HKCR; Subkey: "RWorkspace\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\bin\i386\RGui.exe,0"; Tasks: associate; Check: RIsAdmin 
Root: HKCR; Subkey: "RWorkspace\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\bin\i386\RGui.exe"" --workspace=""%1"""; Tasks: associate; Check: RIsAdmin
