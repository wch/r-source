...
/* FIXME: This'll be a bit of a kludge - the arrays should be
   dynamically extendable for a start... */
...
static int token()
{
    ...
    xxcharsave = xxcharcount; /* want to be able to go back up one token */
